...
# -*- coding: utf-8 -*-
"""
ЭДО ЛДПР - Полная версия для деплоя на Render
Все функции сохранены, интерфейс полностью соответствует оригиналу
"""
...
# ============================================================
# ШАБЛОНЫ (ПОЛНОСТЬЮ ИЗ ОРИГИНАЛА)
# ============================================================
        ...
        <table class="table table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="/department/{{ d.id }}" class="btn btn-sm btn-outline-primary"><i class="bi bi-eye"></i> Просмотр</a></d>
                </tr>
                {% endfor %}
            </tbody>
         </table>
