...
Исправлено: все роли видят распоряжения, данные сохраняются
"""
...
class OrderModel:
    ...
    def get_by_user(uid, role, department_id=None):
        """Правильное получение распоряжений для каждой роли"""
        db = get_db()
                ...
                <div class="col-md-3 mb-3">
                    <div class="card stat-card p-3" onclick="location.href='/orders'">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <small class="text-muted text-uppercase">Всего распоряжений</small>
                        ...
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><small>{{ o.created_at[:16] if o.created_at else '' }}</small></d>
                                    <td>
                                        <a href="/orders/{{ o.id }}" class="btn btn-sm btn-outline-primary">Просмотр</a>
                                    </d>
                                </tr>
                                {% endfor %}
                            </tbody>
        ...
        <div class="col-md-10 p-4">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-header bg-white">
                            <h5 class="mb-0">Распоряжения отдела</h5>
                        </div>
                        <div class="card-body p-0">
                            <div class="list-group list-group-flush">
                                {% for o in orders %}
                                <a href="/orders/{{ o.id }}" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
                                    {{ o.title }}
                                    <span class="badge bg-primary">{{ o.status }}</span>
                                </a>
                                {% else %}
                                <div class="list-group-item text-muted text-center">Нет распоряжений</div>
                                {% endfor %}
                            </div>
                        </div>
                    </div>
...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-10 p-4">
            <h2 class="mb-4"><i class="bi bi-shield-lock me-2"></i>Администрирование</h2>
            
            <div class="card mb-4">
                <div class="card-header bg-white d-flex justify-content-between align-items-center">
                    <h5 class="mb-0"><i class="bi bi-people"></i> Пользователи</h5>
                    <div>
                        <a href="/admin/export/users" class="btn btn-success btn-sm me-2">Excel</a>
                        <button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#addUserModal">+ Добавить</button>
                    </div>
                </div>
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="/admin/users/{{ u.uid }}/delete" class="btn btn-sm btn-outline-danger" onclick="return confirm('Удалить пользователя?')">
            ...
            <div class="card">
                <div class="card-header bg-white d-flex justify-content-between align-items-center">
                    <h5 class="mb-0"><i class="bi bi-building"></i> Отделы</h5>
                    <button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#addDeptModal">+ Добавить отдел</button>
                </div>
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="/admin/departments/{{ d.id }}/delete" class="btn btn-sm btn-outline-danger" onclick="return confirm('Удалить отдел?')">
                                            <i class="bi bi-trash"></i>
                                        </a>
                                    </d>
                                </tr>
    ...
    <div class="row">
        <div class="col-md-2 sidebar p-3">
            ...
            <nav class="nav flex-column">
                ...
                {% if current_user.role == 'admin' %}
                <a class="nav-link" href="/admin">Администрирование</a>
                <a class="nav-link active" href="/admin/stats">Статистика</a>
                {% endif %}
            </nav>
        </div>
        <div class="col-md-10 p-4">
            <h2 class="mb-4"><i class="bi bi-graph-up me-2"></i>Статистика системы</h2>
            
            <div class="row mb-4">
                <div class="col-md-3 mb-3">
                    <div class="card text-center p-3">
                        <i class="bi bi-people fs-1 text-primary"></i>
                        <h3 class="mb-0 mt-2">{{ user_stats.total }}</h3>
                ...
                <div class="col-md-3 mb-3">
                    <div class="card text-center p-3">
                        ...
                        <h3 class="mb-0 mt-2">{{ dept_stats.total }}</h3>
                ...
                <div class="col-md-3 mb-3">
                    <div class="card text-center p-3">
                        ...
                        <h3 class="mb-0 mt-2">{{ order_stats.total }}</h3>
                        <small class="text-muted">Распоряжений</small>
                    </div>
                </div>
                <div class="col-md-3 mb-3">
                    <div class="card text-center p-3">
                        <i class="bi bi-check-circle fs-1 text-info"></i>
                        <h3 class="mb-0 mt-2">{{ completed_orders }}</h3>
            ...
            <div class="card">
                ...
                <div class="card-body p-0">
                    <table class="table table-hover mb-0">
                        <thead class="table-light">
                            <tr><th>Роль</th><th>Количество</th><th>Процент</th></tr>
                        </thead>
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    ...
                                    {% elif role == 'secretary' %}Секретарь
                                    {% elif role == 'head_central' %}Руководитель ЦА
                                    {% elif role == 'head_department' %}Начальник отдела
                                    {% elif role == 'assistant' %}Помощник
                                    {% else %}Исполнитель{% endif %}
                                </d>
                                <td>{{ count }}</d>
                                <td>{{ (count / user_stats.total * 100)|round(1) if user_stats.total > 0 else 0 }}%</d>
                            </tr>
                            {% endfor %}
                        </tbody>
                    </table>
